...
type BalanceAdapter interface {
	...
	TransferMoney(ctx context.Context, senderOptions *balances.TransferOptions, receiptOptions *balances.TransferOptions, senderId string, receiptId string) error
}
